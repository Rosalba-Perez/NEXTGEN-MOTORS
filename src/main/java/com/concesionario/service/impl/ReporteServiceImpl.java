...
import com.concesionario.service.interfaces.IReporteService;
        ...
        try (Workbook workbook = new XSSFWorkbook()) {
            ...
            for (Usuario usuario : usuarios) {
                ...
                dataRow.createCell(2)
                        .setCellValue(usuario.getApellidoUser() != null ? usuario.getApellidoUser() : "N/A");
                dataRow.createCell(3).setCellValue(
                        usuario.getIdentificacionUser() != null ? usuario.getIdentificacionUser() : "N/A");
                ...
                dataRow.createCell(6)
                        .setCellValue(usuario.getAntiguedadCuenta() != null ? usuario.getAntiguedadCuenta() : 0);
                dataRow.createCell(7)
                        .setCellValue(usuario.getEstadoUltimaCita() != null ? usuario.getEstadoUltimaCita() : "N/A");
                dataRow.createCell(8)
                        .setCellValue(usuario.getInteresVehiculo() != null ? usuario.getInteresVehiculo() : "N/A");
                dataRow.createCell(9)
                        .setCellValue(usuario.getTiempoEntreCitas() != null ? usuario.getTiempoEntreCitas() : 0);

                // Predicciones
                dataRow.createCell(10)
                        .setCellValue(usuario.getClientePotencial() != null ? usuario.getClientePotencial() : "No");
                ...
                dataRow.createCell(13).setCellValue(
                        usuario.getObservaciones() != null ? usuario.getObservaciones() : "Sin observaciones");
