...
@Service
public class TrabajadorDetailsServiceImpl implements ITrabajadorDetailsService {

    private final TrabajadorRepository trabajadorRepository;
    private final CitaRepository citaRepository;
    private final UsuarioRepository usuarioRepository;

    public TrabajadorDetailsServiceImpl(TrabajadorRepository trabajadorRepository,
    ...
    public Map<String, Object> obtenerDatosAsesor(String asesorId) {
        ...
        double tasaConversion = citasValidas.isEmpty() ? 0 : (ventasMes * 100.0) / citasValidas.size();
    ...
    private Map<String, Object> convertirCitaAProspecto(Cita cita) {
        ...
        // ✅ CORREGIR: Obtener nombres y apellidos del USUARIO EMBEBIDO, no de la cita
        // directamente
