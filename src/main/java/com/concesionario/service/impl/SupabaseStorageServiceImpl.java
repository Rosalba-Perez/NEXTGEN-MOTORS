...
public class SupabaseStorageServiceImpl implements ISupabaseStorageService {
    ...
    // NOTE: Using service_role key to ensure write access. In production, use env
    // variables!
    private static final String SUPABASE_KEY = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InlzenllbmJwc21hdXVqeXVpbG4iLCJyb2xlIjoic2VydmljZV9yb2xlIiwiaWF0IjoxNzY4NzU2MjI5LCJleHAiOjIwODQzMzIyMjl9.RsJuisijWi3GcCrxbVqNlntuzHSZjVRaSMMVofkn34I";
        ...
        try {
            ...
            if (response.getStatusCode().is2xxSuccessful()) {
                ...
                throw new IOException(
                        "Failed to upload to Supabase: " + response.getStatusCode() + " Body: " + response.getBody());
            }
        } catch (Exception e) {
